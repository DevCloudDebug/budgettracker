...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Modal, TextInput, SafeAreaView, KeyboardAvoidingView, Platform, RefreshControl, Dimensions } from 'react-native';
